...
.red {
	...
	<div class="rsform-column-10">
		...
		<?php } ?>
		<h2>Changelog v3.0.15</h2>
		<ul class="version-history">
			<li><span class="version-upgraded">Upg</span> 'From Name' in 'Additional Emails' now shows up as required.</li>
			<li><span class="version-upgraded">Upg</span> Scripts and stylesheets are now checked if present on the page when being added through the System - RSForm! Pro Plugin.</li>
			<li><span class="version-fixed">Fix</span> jQuery will now be loaded even if the form is placed using the System - RSForm! Pro Plugin.</li>
			<li><span class="version-fixed">Fix</span> There was an issue when sending emails on hosts with disabled escapeshellarg() and escapeshellcmd() functions.</li>
			<li><span class="version-fixed">Fix</span> No longer specifying min-height for rows when using the Responsive layout as that could create unnecessary whitespace.</li>
		</ul>
