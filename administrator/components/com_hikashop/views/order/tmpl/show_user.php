...
window.orderMgr.updateUser = function() {
	window.Oby.xRequest('<?php echo hikashop_completeLink('order&task=show&subtask=user&cid='.$this->order->order_id, true, true, true); ?>', {update: 'hikashop_order_field_user'});
}
//-->
</script>
