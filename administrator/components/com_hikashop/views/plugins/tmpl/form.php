...
?>
				<tr>
					<td class="key">
						<label for="data[payment][payment_params][payment_zip_regex]"><?php
							echo JText::_('SHIPPING_ZIP_REGEX');
						?></label>
					</td>
					<td>
						<input type="text" name="data[payment][payment_params][payment_zip_regex]" value="<?php echo @$this->element->payment_params->payment_zip_regex; ?>"/>
					</td>
				</tr>
				<tr>
					<td class="key">
