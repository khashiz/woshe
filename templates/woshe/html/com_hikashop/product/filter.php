...
?>
<div id="hikashop_filter_main_div_<?php echo $this->params->get('main_div_name'); ?>" class="uk-width-1-1 uk-width-1-4@m <?php echo $content_classes.$display_title_class; ?>" <?php echo $extra_attributes; ?>>
<?php
	if($this->params->get('module') == 'mod_hikashop_filter') {
?>
...
";
?>
	<span class="uk-hidden hikashop_filter_button_outside" <?php echo $style; ?>>
