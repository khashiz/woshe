...
if(!empty($this->links->previous)) {
	echo '<div class="hikashop_previous_product_btn '.$css_button.'">'.
		'<a title="'.JText::_('PREVIOUS_PRODUCT').'" href="'.$this->links->previous.'">'.
...
if(!empty($this->links->next)) {
	echo '<div class="hikashop_next_product_btn '.$css_button.'">'.
		'<a title="'.JText::_('NEXT_PRODUCT').'" href="'.$this->links->next.'">'.
...
<?php
	if(!empty ($this->modules) && is_array($this->modules)) {
	    echo '<hr class="uk-divider-icon uk-margin-large-bottom uk-margin-large-top">';
