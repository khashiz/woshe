...
<?php
	...
	if($enableCarousel) {
		...
		if($row_fluid == 12)
			echo '<div class="uk-child-width-1-1 uk-child-width-1-'.$columns.'@m" data-uk-grid data-uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > div; delay: 250;">';
		else
			echo '<div class="gggggggggb hk-row-fluid hk-row-'.$row_fluid.'">';
...
?>
<form action="<?php echo str_replace('&tmpl=raw', '', hikashop_currentURL()); ?>" method="post" name="adminForm_<?php echo $mainDivName . $this->category_selected; ?>_bottom" class="uk-hidden">
