...
<div id="hikashop_checkout_cart_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" data-checkout-step="<?php echo $this->step; ?>" data-checkout-pos="<?php echo $this->module_position; ?>" class="uk-width-1-1 hikashop_checkout_cart">
<?php } ?>
...
?>
    <h5 class="uk-display-block font f600 uk-text-dark uk-margin-remove-top"><?php echo JText::_('ORDER_SUMMERY'); ?></h5>
...
<!-- EO PAYMENT ROW -->
    ...
    <div class="uk-grid-small" data-uk-grid>
        <div id="hikashop_checkout_cart_total2_title" class="uk-width-expand uk-text-small font uk-text-gray f500 hikashop_cart_subtotal_title hikashop_cart_title" data-uk-leader><?php echo JText::_('HIKASHOP_TOTAL'); ?></div>
    ...
    <?php if(!empty($this->options['show_price']) && !empty($cart->coupon) && !empty($this->options['show_coupon'])) { ?>
        <div class="uk-grid-small" data-uk-grid>
            <div id="hikashop_checkout_cart_coupon_title" class="uk-width-expand uk-text-small font uk-text-gray f500 hikashop_cart_coupon_title hikashop_cart_title" data-uk-leader><?php echo JText::_('HIKASHOP_COUPON'); ?></div>
            <div class="uk-text-small font uk-text-secondary f500 hikashop_cart_coupon_value">
    ...
    <?php if(!empty($this->options['show_price']) && !empty($cart->shipping) && !empty($this->options['show_shipping'])) { ?>
        <div class="uk-grid-small" data-uk-grid>
            <div id="hikashop_checkout_cart_shipping_title" class="uk-width-expand uk-text-small font uk-text-gray f500" data-uk-leader><?php echo JText::_('HIKASHOP_SHIPPING_PRICE'); ?></div>
            <div class="uk-text-small font uk-text-secondary f500 hikashop_cart_shipping_value">
    ...
    <?php if(!empty($this->options['show_price'])) { ?>
        <div class="uk-grid-small" data-uk-grid>
            <div id="hikashop_checkout_cart_final_total_title" class="uk-width-expand uk-text-small font uk-text-gray f500 hikashop_cart_total_title hikashop_cart_title" data-uk-leader><?php echo JText::_('HIKASHOP_TOTAL_ORDER'); ?></div>
            <div class="uk-text-small font uk-text-secondary f500 hikashop_cart_total_value">
                <span class="hikashop_checkout_cart_final_total"><?php echo $this->currencyClass->format($displayingPrices->total->price_value_with_tax, $displayingPrices->price_currency_id); ?></span>
            </div>
        </div>
    <?php } ?>
    <!-- EO TOTAL ROW -->
