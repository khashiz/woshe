...
<div id="hikashop_checkout" data-checkout-step="<?php echo $this->step; ?>" class="uk-width-1-1 uk-width-2-3@m uk-margin-auto hikashop_checkout_page hikashop_checkout_page_step<?php echo $this->step; ?>">
