...
?><div class="hikashop_checkout_buttons uk-width-1-1">
...
<!-- NEXT BUTTON -->
		<button id="hikabtn_checkout_next" type="submit" class="uk-button uk-button-primary uk-button-large uk-width-1-1 hikabtn_checkout_next" onclick="return window.checkout.submitStep(this);"><?php
