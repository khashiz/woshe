...
<div id="hikashop_user_addresses_default">
	...
	<dl class="hika_options large hikashop_default_billing_address uk-hidden">
		<h5 class="" for="hikashop_default_billing_address_selector"><?php echo JText::_('HIKASHOP_SELECT_DEFAULT_BILLING_ADDRESS'); ?></h5>
		<div><?php
			$current = 0;
			$values = array();
	...
	<div class="uk-margin-medium-bottom">
		<h5 class="uk-display-block font f600 uk-text-dark" for="hikashop_default_shipping_address_selector"><?php echo JText::_('HIKASHOP_SELECT_DEFAULT_SHIPPING_ADDRESS'); ?></h5>
		<div>
            <?php
			$current = 0;
			$values = array();
			...
			if(empty($values))
				$values = array(JHTML::_('select.option', '', JText::_('HIKA_NO_ADDRESS')));
			echo JHTML::_('select.genericlist', $values, 'data[user][default_shipping]', 'class="uk-select uk-width-1-1 font" onchange="window.addressMgr.setDefault(this, \'shipping\');"', 'value', 'text', $current, 'hikashop_default_shipping_address_selector');
		?>
        </div>
	</div>
    <?php } ?>
...
?>
		<div>
			<a class="" href="#newAddress" onclick="return window.addressMgr.new('billing');"><i class="fa fa-plus"></i> <?php echo JText::_('HIKASHOP_NEW_BILLING_ADDRESS'); ?></a>
		</div>
	</div>
	<div>
        ...
        <?php } else { ?>
            <div>
                <div class="uk-placeholder uk-placeholder-large uk-height-medium uk-flex uk-flex-middle uk-flex-column uk-flex-center">
                    <p class="font uk-h6 f500 uk-text-muted"><?php echo JText::_('HIKA_CPANEL_NO_ADDRESSES'); ?></p>
                    <div>
                        <a class="uk-button uk-button-primary font" href="#newAddress" onclick="return window.addressMgr.new('shipping');"><?php echo JText::_('HIKASHOP_NEW_SHIPPING_ADDRESS'); ?></a>
                    </div>
                </div>
