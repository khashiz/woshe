...
<div class="password-group">
	<div class="uk-position-relative input-group">
        ...
        <div class="uk-position-center-left uk-margin-small-left input-password-toggle">
            <?php if (!$lock): ?>
                <img class="icon-eye" src="<?php echo JURI::base().'images/sprite.svg#eye' ?>" width="24" height="24" data-uk-svg>
                <button type="button" class="btn btn-secondary uk-hidden">
                    <span class="icon-eye icon-fw" aria-hidden="true">
                    </span>
                    <span class="visually-hidden"><?php echo Text::_('JSHOWPASSWORD'); ?></span>
                </button>
            <?php else: ?>
                <button type="button" id="<?php echo $id; ?>_lock" class="btn btn-info input-password-modify locked"><?php echo Text::_('JMODIFY'); ?></button>
            <?php endif; ?>
        </div>
	</div>
</div>
