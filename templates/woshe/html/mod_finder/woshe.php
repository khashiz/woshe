...
<div class="uk-width-auto search">
    <div>
        <div class="uk-flex">
            <div>
                <a href="#" onclick="jQuery('.searchWrapper').toggle('slide');" class="uk-display-block uk-text-dark hoverPrimary"><img src="<?php echo JUri::base().'images/sprite.svg#search'; ?>" width="20" height="20" data-uk-svg></a>
            </div>
            <div class="searchWrapper uk-margin-small-right">
